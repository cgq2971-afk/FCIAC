...
from dataloader.dataloader import get_dataloader, get_dataset_for_data_init, get_testloader,custom_collate
...
class Trainer(object, metaclass=abc.ABCMeta):
    ...
    def replace_base_fc(self, trainset, model):
        ...
        trainloader = torch.utils.data.DataLoader(dataset=trainset, batch_size=128,
                                                num_workers=8, pin_memory=True, shuffle=False,collate_fn=custom_collate)
